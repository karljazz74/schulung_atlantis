...
// added for Details View 04.12.2023
...
function getFlagCode(lang) {
    if (!lang || !lang.lang || !lang.code) {
        console.warn('getFlagCode was called with invalid data:', lang);
        return 'default'; // Return a default flag code if data is not as expected
    }

    if (lang.lang === 'es-MX') {
        return 'mx'; // Return 'mx' for Mexican flag
    }
    return lang.code.toLowerCase(); // Use the language code as the flag code
}
...
async function loadImages() {
    for (const record of recordsData.value) {
        ...
        console.log('Loaded images for record:', record.id_record, galleriaImages);
    }
}
...
// Modified loadData function to fetch data dynamically
async function loadData(langCode = 'en-US') {
    try {
...
// modified 12.10 to store the language, and not only change the selection
...
const navigateToDetail = (id) => {
    console.log('Router:', router); // Debug log
        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column :header="t('recordHeaders.view_details')" style="max-width: 3rem">
                        <template #body="{ data }">
                    ...
                    <Column :header="t('recordHeaders.images')" style="max-width: 8rem">
                        <template #body="{ data }">
                    ...
                    <!-- Rest of the fields -->
                    <Column field="obj_designation" :header="t('recordHeaders.obj_designation')" style="max-width: 4rem">
                        <template #body="{ data }">

...
const fetchBlogs = async () => {
  ...
  try {
    ...
    if (data && data.blogs) {
      ...
      totalBlogs.value = transformedBlogs;
    } else {
      totalBlogs.value = [];
    }

    console.log("totalBlogs:", totalBlogs.value);  // Log the transformed array
  } catch (error) {
                    ...
                    <div class="p-3">
                        <div class="border-1 surface-border cursor-pointer z-index border-round">
                            <div class="relative">
                                ...
                                <img :src="data.profile" v-if="data.profile" class="cardImage flex absolute w-4rem h-4rem" :alt="data.description.split(' ', 1)" />
                                </div>
                            <div class="p-3">

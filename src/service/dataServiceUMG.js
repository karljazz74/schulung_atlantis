    ...
    try {
        const query = `query {
            records(limit: 500) {
                  ...
                  find_location
                  lote_number
                  translations_records(filter: { languages_code: { code: { _eq: "es-ES" } } }) { 
                      languages_code {
                          code
                      }
                      tr_description
                  ...
                  fk_category {
                      TranslationCat: translations(filter: { languages_code: { code: { _eq: "es-ES" } } }) {
                          obj_categories
                          obj_description
                  ...
                  fk_files_images {
                      directus_files_id {
                          id
                          image_number
                          translations(filter: {languages_code: {code: {_eq: "es-ES"}}}) {
                              figure_caption_name
                              languages_code {
                                  code
                              }
